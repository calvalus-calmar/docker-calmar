...
hdfs dfs -copyFromLocal gdal.jar /calvalus/software/1.0/calvalus-2.19-SNAPSHOT
...
hdfs dfs -copyFromLocal calvalus/snap-python/org-esa-snap-snap-python.jar /calvalus/software/1.0/snap-7.0.4cv-SNAPSHOT

# add bundle-descriptor.xml - to help register product file formats in portal
hdfs dfs -copyFromLocal calvalus/snap-bundle/resources/bundle-descriptor.xml /calvalus/software/1.0/snap-7.0.4cv-SNAPSHOT
